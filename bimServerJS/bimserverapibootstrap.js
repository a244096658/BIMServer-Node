...
function loadBimServerApi(address, version, callback, errorCallback) {
	requirejs.config({
	    baseUrl: address + "/apps/bimserverjavascriptapi/js",
	    urlArgs: "_v=" + version
	});

	requirejs(["bimserverclient", "bimserverapipromise"], function(BimServerApi, BimServerApiPromise) {
...
exports.loadBimServerApi = loadBimServerApi;
